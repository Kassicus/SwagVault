...
<body style="font-family: 'DM Sans', Arial, sans-serif; margin: 0; padding: 40px 20px; background-color: #f8fafc;">
  <div style="max-width: 480px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 40px; border: 1px solid #e2e8f0;">
    ...
    <p style="color: #64748b; font-size: 14px; margin: 0 0 24px;">Order Update</p>

    <p style="color: #0a0e1a; font-size: 16px; line-height: 1.6;">
      Your order <strong>#${orderNumber}</strong> from <strong>${orgName}</strong> has been updated.
    </p>
    ...
    <div style="margin: 24px 0; padding: 16px; background: #f8fafc; border-radius: 8px; text-align: center;">
      ...
      <p style="margin: 8px 0 0; color: #0a0e1a; font-size: 18px; font-weight: 600;">${statusLabel}</p>
    </div>

    <p style="color: #64748b; font-size: 13px; line-height: 1.5;">
      Log in to your vault to view the full order details.
    </p>
  </div>
</body>
</html>`.trim();
